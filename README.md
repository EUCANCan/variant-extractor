...
| AGTG | A                                        | INDEL_DEL    | Indel deletion                                                |
| A    | ACCT                                     | INDEL_INS    | Indel insertion                                               |
...
| 2     | 3   | event_2_1 | T   | A   | PASS   | SNV                           |
| 2     | 4   | event_2_2 | A   | G   | PASS   | SNV                           |
| 2     | 5   | event_2_3 | G   | T   | PASS   | SNV                           |

### Indels
All entries with the `REF/ALT` of different lengths are treated as indels. If the `REF` sequence is longer than the `ALT` sequence, it is considered a deletion. If the `REF` sequence is shorter than the `ALT` sequence, it is considered an insertion. For example:

| CHROM | POS | ID      | REF | ALT | FILTER | [`VariantType`](#varianttype) |
| ----- | --- | ------- | --- | --- | ------ | ----------------------------- |
| 2     | 3   | event_1 | T   | TGT | PASS   | INDEL_INS                     |
| 2     | 10  | event_2 | TA  | AAT | PASS   | INDEL_INS                     |
| 2     | 5   | event_3 | TAG | T   | PASS   | INDEL_DEL                     |
| 2     | 8   | event_4 | TAG | AG  | PASS   | INDEL_DEL                     |
